            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-offset-2">
                        <h1 class="brand-heading">Uw bent ingelogd</h1>
                        <p class="intro-text">Klik hier om door te gaan naar de dashboard.</p>
                         <a href="Dashboard.php" class="btn btn-circle page-scroll">
                             <i> Dashboard </i></a>
                    </div>
                </div>
            </div>
