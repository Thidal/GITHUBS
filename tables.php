        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <h2>bootstrapp Docs</h2>
                        <p>For complete documentation, please visit <a target="_blank" href="http://getbootstrapp.com/css/#tables">bootstrapp's Tables Documentation</a>.</p>
                    </div>
                </div>
                <!-- /.row -->
